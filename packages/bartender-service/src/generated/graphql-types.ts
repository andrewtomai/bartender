...
export type CacheControlDirectiveArgs = { maxAge?: Maybe<Scalars['Int']>; scope?: Maybe<CacheControlScope> };
...
> = {
    ...
    occupant?: Resolver<
        Maybe<ResolversTypes['Occupant']>,
        ParentType,
        ContextType,
        RequireFields<QueryOccupantArgs, 'occupant'>
    >;
    drink?: Resolver<Maybe<ResolversTypes['Drink']>, ParentType, ContextType, RequireFields<QueryDrinkArgs, 'id'>>;
    listDrinks?: Resolver<
        Array<Maybe<ResolversTypes['Drink']>>,
        ParentType,
        ContextType,
        RequireFields<QueryListDrinksArgs, 'query'>
    >;
};
...
> = {
    ...
    joinRoom?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<MutationJoinRoomArgs, 'occupant'>
    >;
    leaveRoom?: Resolver<
        Maybe<ResolversTypes['Occupant']>,
        ParentType,
        ContextType,
        RequireFields<MutationLeaveRoomArgs, 'occupant'>
    >;
    updatePreferences?: Resolver<
        Maybe<ResolversTypes['Occupant']>,
        ParentType,
        ContextType,
        RequireFields<MutationUpdatePreferencesArgs, 'occupantId' | 'preferences'>
    >;
    createDrink?: Resolver<
        ResolversTypes['Drink'],
        ParentType,
        ContextType,
        RequireFields<MutationCreateDrinkArgs, 'drink'>
    >;
};
...
export type OccupantResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['Occupant'] = ResolversParentTypes['Occupant']
> = {
...
export type DrinkResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['Drink'] = ResolversParentTypes['Drink']
> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type IngrediantResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['Ingrediant'] = ResolversParentTypes['Ingrediant']
> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type QuantifiedIngrediantResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['QuantifiedIngrediant'] = ResolversParentTypes['QuantifiedIngrediant']
> = {
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
